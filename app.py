...
Version: v2.5.5_20260821
Description: 提供 CAD 報價辨識工具。
             修復新版 Streamlit 之 st.image 使用 use_container_width 代替舊版 use_column_width。
...
def inject_custom_elements():
    ...
    <div class="version-badge-left">Version: v2.5.5_20260821</div>
...
st.set_page_config(page_title="CAD 報價辨識工具 (v2.5.5)", page_icon="⚙️", layout="centered")
            ...
            with st.expander(f"📄 {res['file_name']} - 【尺寸：{display_dims_escaped} mm ({used_mode})】"):
                ...
                with col_p2:
                    if is_valid_image(res.get("image_path")):
                        # 更換舊參數 use_column_width -> use_container_width
